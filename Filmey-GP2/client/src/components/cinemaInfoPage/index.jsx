          ...
          {cinema == "muvi" && (
            <div className="cinemaInfoLogo">
              <a href="https://www.muvicinemas.com/en" target="_blank">
                <img
                  src={muviLogo}
                  // src = {require("../../dist/img/muviLogo.png")}
          ...
          {cinema == "vox" && (
            <div className="cinemaInfoLogo">
              <a href="https://ksa.voxcinemas.com/" target="_blank">
                <img src={voxwhite} height="350" width="250" />
              </a>
            </div>
          )}
          ...
          {cinema == "amc" && (
            <div className="cinemaInfoLogo">
              <a href="https://www.amctheatres.com/" target="_blank">
                <img src={amcLogo} height="250" width="350" />
              </a>
            </div>
          )}
            ...
            <div className="aboutText  neuton-normal-white-60px5">
              ...
              {cinema == "vox" && (
                <div className="aboutCinema">
                  ...
                  cinema, which will be the first multiplex in Saudi Arabia will
                  open at Riyadh Park Mall. VOX Cinemas will start delivering on
                  an ambitious plan to bring its world-class cinema
                  entertainment portfolio to Saudi Arabia and support the growth
                  of audio-visual and creative talent across the Kingdom. VOX
                  Cinemas parent company Majid Al Futtaim, the leading shopping
                  mall, communities, retail and leisure pioneer across the
                  Middle East, Africa and Asia is an active supporter of the
                  Kingdom’s Vision 2030. Majid Al Futtaim has already announced
                  project investments valued at SAR 14 billion across their mall
                  asset, fashion, leisure and retail offerings in the Kingdom of
                  Saudi Arabia. This commitment is expected to create more than
                  114,000 direct and indirect job opportunities.
                </div>
              )}
              {cinema == "amc" && (
                <div className="aboutCinema">
                  ...
                  Dolby Cinema®, and IMAX® technologies. Taste our special menu
                  of elevated cinema favorites and enjoy bolder flavors, wider
                  ...
                  the spacious comforts of our luxe recliners. Come and enjoy
                  the very best of cutting-edge entertainment when you choose
                  AMC Cinemas.
                </div>
              )}
              {cinema == "muvi" && (
                      ...
                      <div key={i}>
                        {
                          <div className="cinemaLocation">
                            ...
                            <div className="cinemaLocationsName">
                              {" "}
                              {cinemaLocations[i]} -{" "}
