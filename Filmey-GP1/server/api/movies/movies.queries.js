...
async addDirector(movie_id,directors) {
  ...
  // console.log(movieRoles);
    ...
    let director_ids = await db(tableNames.movie_Director).select("*").where({
      movie_id: id,
    }).returning("*").pluck("director_id");
    ...
    let writer_ids = await db(tableNames.movie_Writer).select("*").where({
      movie_id: id,
    }).returning("*").pluck("writer_id");
    //console.log("director_ids");
    ...
    {
      //console.log(actorId);
      let movieWriter= await db(tableNames.writer).select("*").where({
        writer_id: id,
      }).returning("*").pluck("writer");
      //console.log("movieDirectors");
      //console.log(movieDirectors);
  ...
  //   }).returning("*").pluck("writer");
    ...
    console.log(arrayofGenres);
    console.log(arrayofLanguages);
    return {movieInfo,arrayofGenres,arrayofLanguages,actorInfoArray,arrayofDirectors,arrayofWriters};
    //return movieGenres;
    //console.log(movieGenres);
    // console.log(movieLanguages);
    // console.log(movieRoles);
