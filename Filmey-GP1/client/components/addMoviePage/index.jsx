...
const setActorImage = (index, value) => {
  ...
  React.useEffect(() => {
    ...
    if(id>0)
    {
      ...
      console.log(response.data.arrayofGenres.length);
       
      //  const getGenresArray = [...getGenre];
      //  for (var i = 0; i < response.data.arrayofGenres.length; i++) {
      //   getGenresArray[i] = response.data.arrayofGenres[i];
      //   console.log(response.data.arrayofGenres[i]);
      // }
      // setGetGenre(getGenresArray);
 ...
 {/* Actors */}
  <div className="addMovieflex-row-1 nunito-normal-white-35px">
        ...
        {/* )} */}
        {/* {id>0 && ( */}
        <button className="addMovieadd-button neuton-bold-white-30px7" >edit</button>
        {/* )} */}
      </div>
    </div>
